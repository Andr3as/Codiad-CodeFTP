        ...
        <table id="ftp_list">
            <tr>
                <td>
                    ...
                    <i class="icon-info" onclick='codiad.CodeFTP.localInfo();'></i>
                    <i class="icon-key" onclick='codiad.CodeFTP.fileModeSel("localSel");'></i>
                ...
                <td>
                    ...
                    <i class="icon-key" onclick='codiad.CodeFTP.fileModeSel("serverSel");'></i>
